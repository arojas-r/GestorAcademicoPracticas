...
<head>
    ...
    <style>
        /* Estilo para alinear el título y los botones */
        .header-with-buttons {
            display: flex;
            align-items: center;
        ...
        /* Añade estilos para los botones si no están definidos en estilos.css */
        .btn {
            padding: 8px 12px;
            border: none;
            cursor: pointer;
        ...
        /* Estilos del modal (asegúrate de que estén definidos si no lo están en estilos.css) */
        .modal-overlay {
...
<form id="matriculasForm">
    <table>
        <thead>
            <tr>
                <th></th><th>ID</th><th>Curso</th><th>Alumno</th><th>Estado</th>
            </tr>
        </thead>
        <tbody>
