...
// Eliminar un solo profesor (se mantiene por compatibilidad)
...
// Añadir o modificar profesor (sin cambios en esta sección)
    ...
    <main>
        ...
        <div class="search-container">
            <form action="" method="GET" class="global-actions">
                <input class="buscador-bar" type="text" name="search_dni" placeholder="Buscar profesor por DNI, Nombre o Apellido..." value="<?= htmlspecialchars($search) ?>">
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" class="profesor-checkbox"
                                    ...
                                    data-profesor='<?= htmlspecialchars(json_encode($p), ENT_QUOTES, 'UTF-8') ?>'>
                            </td>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            btnModificar.addEventListener('click', function() {
                const seleccionados = document.querySelectorAll('.profesor-checkbox:checked');
                ...
                // Parseamos el JSON guardado en el atributo data-profesor
                const profesorData = JSON.parse(checkbox.dataset.profesor);

                // Reutilizamos la función existente para mostrar el formulario con los datos
                showForm(profesorData);
            });
            ...
            btnEliminar.addEventListener('click', function() {
                ...
                const confirmacion = confirm(`¿Está seguro de que desea eliminar ${seleccionados.length} profesor(es) seleccionado(s)?`);
