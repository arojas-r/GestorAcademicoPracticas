...
if (!empty($search)) {
    $stmt = $pdo->prepare("
        SELECT Curso.*, CONCAT(Profesor.Nombre, ' ', Profesor.Apellido) AS Profesor_Nombre
        FROM Curso
        LEFT JOIN Profesor ON Curso.DNIP = Profesor.DNI
        WHERE Curso.ID_Curso LIKE ?
           OR Curso.Nombre_Curso LIKE ?
           OR Profesor.Nombre LIKE ?
           OR Profesor.Apellido LIKE ?
    ");
    $searchParam = '%' . $search . '%';
        ...
        <div id="modalOverlay" class="modal-overlay">
            <div class="modal-content">
                ...
                <form method="post" id="formCurso">
                    ...
                    <label>Fecha Fin:<br><input type="date" name="fecha_fin" id="fecha_fin"></label>
